...
| Charvee | `task1_llm/charvee/checkpoints/gpt_charvee.pt` | `task1_llm/charvee/metrics_report.csv` | `task1_llm/charvee/raw_train_log.txt` |
...
| Charvee | baseline_maxpool_mlp | `task2_sentiment/charvee/checkpoints/baseline_maxpool_mlp.pt` | `task2_sentiment/charvee/metrics_report.csv` (row 1) | `task2_sentiment/charvee/raw_train_log.txt`* |
| Charvee | experimental_gru | `task2_sentiment/charvee/checkpoints/experimental_gru.pt` | (row 2) | — |
| Charvee | experimental_dilated_cnn | `task2_sentiment/charvee/checkpoints/experimental_dilated_cnn.pt` | (row 3) | — |
...
| Charvee | `task3_gan/charvee/checkpoints/{G_AB,G_BA,D_A,D_B}.pt` | `task3_gan/charvee/metrics_report.csv` | `task3_gan/charvee/raw_train_log.txt` |
